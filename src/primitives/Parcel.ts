...
/**
 * A unit that collects transactions and requests processing to the network. A single account pays for CCC processing fees.
 * - The fee must be at least 10. The higher the fee, the higher the priority for the Parcel to be processed.
 * - It assigns the network ID. This must be identical to the network ID to which the parcel is being sent to.
